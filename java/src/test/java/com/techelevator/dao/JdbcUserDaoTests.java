...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1001, "trainer", "user1", "ROLE_TRAINER");
    protected static final User USER_2 = new User(1002, "user2", "user2", "ROLE_USER");
    private static final User USER_3 = new User(1003, "user3", "user3", "ROLE_USER");
